...
<body>
    ...
    <form action="../htmlephp/pedir.php" method="get">
        <div id="linhas_inicio">
            <div id="linha_1_inicio">
                <p class="texto_pequena">Pizza Pequena R$ 35,00</p>
                <a href="../htmlephp/sabores_figma_html.php"><img class="pizza_pequena" src="../imgs/pizza_pequena.png" alt="Pizza Pequena"></a>
            </div>

            <div id="linha_2_inicio">
                <p class="texto_media">Pizza Média R$ 45,00</p>
                <a href="../htmlephp/sabores_figma_html.php"><img class="pizza_media" src="../imgs/pizza_media.png" alt="Pizza Média"></a>
            </div>

            <div id="linha_3_inicio">
                <p class="texto_grande">Pizza Grande R$ 60,00</p>
                <a href="../htmlephp/sabores_figma_html.php"><img class="pizza_grande" src="../imgs/pizza_grande.png" alt="Pizza Grande"></a>
            </div>

            <div id="linha_4_inicio">
                <p class="texto_gigante">Pizza Gigante R$ 75,00</p>
                <a href="../htmlephp/sabores_figma_html.php"><img class="pizza_gigante" src="../imgs/pizza_gigante.png" alt="Pizza Gigante"></a>
